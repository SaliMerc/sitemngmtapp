# Generated by Django 5.1.5 on 2025-03-19 12:44
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('monthly_subscription_amount', models.DecimalField(decimal_places=2, default=0.0, max_digits=10)),
                ('yearly_subscription_amount', models.DecimalField(decimal_places=2, default=0.0, max_digits=10)),
            ],
        ),
        migrations.CreateModel(
            name='ActivityReport',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('start_date', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='site_app.transactions')),
            ],
        ),
    ]
